defmodule SemesterprojectWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SemesterprojectWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SemesterprojectWeb.Gettext, "errors", msg, opts)
    end
  end
